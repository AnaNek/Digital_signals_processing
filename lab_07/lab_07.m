...
% у нас метод регуляризации тихонова. есть 2 сигнала: первый оригинальный,
% второй -- искажённый. и мы получаем фильтр
...
figure(1);
plot(t, u1+n1, t, u2+n2, t, abs(ifft(fft(u2+n2) .* tikhonfilt(v1, v2, step, 2 * mult, delta, epsilon))));
title('Tikhonov filtering');
legend('Искаженный сигнал u1','Искаженный сигнал u2','Фильтр сигнала');
...
% Calculation of Tikhonov filter
